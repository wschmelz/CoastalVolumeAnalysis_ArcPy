...
![A digital elevation model created from survey data collected within the 'Critical Zone' study area at Sandy Hook, NJ using Delaunay Triangulation.\label{fig:Figure1}](Figure1.png){ width=25% }

![Spatial variability of volumetric change from Jan. 2014 to Jan. 2015 within the 'Critical Zone' study area.\label{fig:Figure2}](Figure3.png){ width=25% }

![Image graphically portraying erosion and deposition within the 'Critical Zone' between January 2014 to January 2015.\label{fig:Figure3}](Figure2.png){ width=25% }
