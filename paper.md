...
![Spatial variability of volumetric change from Jan. 2014 to Jan. 2015 within the 'Critical Zone' study area.The compartments referenced in the image are portrayed spatially in Figure 3.\label{fig:Figure2}](Figure3.png){ width=65% }

![Image graphically portraying erosion and deposition within the 'Critical Zone' between January 2014 to January 2015.\label{fig:Figure3}](Figure2.png){ width=90% }
